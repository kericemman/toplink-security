  ...
  <>
    <section className="border-y border-slate-200 bg-[#F8F7F3] py-24 text-[#0B2F50]">
      <div className="container-custom grid lg:grid-cols-2">
        <div className="border-b border-slate-300 p-8 md:p-12 lg:border-b-0 lg:border-r">
          ...
          <p className="mt-7 text-xs font-extrabold uppercase tracking-[0.18em] text-[#B99753]">Resources &amp; Frameworks</p>
          <h2 className="mt-4 text-3xl font-extrabold">Tools and Knowledge for Advanced Risk Management</h2>
        ...
        <div className="p-8 md:p-12">
          ...
          <p className="mt-7 text-xs font-extrabold uppercase tracking-[0.18em] text-[#B99753]">Security Insights</p>
          <h2 className="mt-4 text-3xl font-extrabold">Actionable Knowledge for Security Leaders</h2>
    ...
    <section className="bg-white py-24">
      <div className="container-custom grid items-center gap-12 lg:grid-cols-[0.9fr_1.1fr]">
        <div>
          <p className="text-xs font-extrabold uppercase tracking-[0.18em] text-[#B99753]">Why Security Leaders Partner with Us</p>
          <h2 className="mt-4 text-3xl font-extrabold tracking-tight text-[#0B2F50] md:text-4xl">Objective Advisory. Proven Methodologies. Enhanced Resilience.</h2>
        </div>
