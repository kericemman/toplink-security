      ...
      <section className="border-b border-slate-200 bg-[#F8F7F3] py-20 lg:py-28">
        <div className="container-custom grid gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
          <div>
            ...
            <h1 className="mt-5 max-w-4xl text-4xl font-extrabold leading-[1.08] text-[#0B2F50] md:text-6xl">Security decisions grounded in risk, governance, and operational reality.</h1>
          </div>
        ...
        <div className="container-custom grid gap-x-10 gap-y-16 lg:grid-cols-2">
          {services.map((service, index) => (
            <article key={service.title} className="group">
              ...
              <div className="grid grid-cols-[56px_1fr] gap-5 border-t-2 border-[#0B2F50] pt-7">
                ...
                <div>
                  ...
                  <Link to={service.path} className="mt-6 inline-flex items-center gap-2 text-xs font-extrabold uppercase tracking-[0.1em] text-[#0B2F50] transition hover:text-[#0CA4B8]">Explore Service <ArrowRight size={16} /></Link>
                </div>
              </div>
            </article>
          ))}
